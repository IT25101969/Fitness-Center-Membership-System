...
## Your Files
- `src\main\java\com\antigravity\fcms\modules\plan\` â€” Backend (model, repository, service, controller)
- `src\main\webapp\modules\plan\` â€” Frontend (html, css, js)
...
2. Create your branch: `git checkout -b feature/plan-module`
3. Work ONLY in your module folder
4. Commit: `git commit -m "feat(plan): your message"`
5. Push and open a Pull Request to main

## Rules
- Only modify files inside `modules/plan/`
