...
fetch('/api/supplements')
  ...
  .catch(function() {
    document.getElementById('spGrid').innerHTML = '<div class="empty-state"><i class="bi bi-exclamation-triangle"></i><p>Could not load supplements.<br><small style="color:rgba(255,255,255,.4)">Start the Spring Boot server to load products.</small></p></div>';
  });
